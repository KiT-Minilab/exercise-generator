...
func NewApiHandler(logger *zap.Logger, cfg *config.Config) *ApiHandler {
	svc := service.NewService(logger, cfg)
...
func (h *ApiHandler) writeJSON(w http.ResponseWriter, status int, data map[string]interface{}, headers http.Header) error {
...
func (h *ApiHandler) readJSON(w http.ResponseWriter, r *http.Request, dst interface{}) error {
